...
///////////////////////////////Company Class////////////////////////////////////
    ...
    public class Company{
        private static int [][]Office_Chairs=new int[7][5];    //Holds Office Chairs Amounts 
        private static int [][]Office_Desks=new int[5][4];      //Holds Office Desks Amounts 
        private static int [][]Meeting_Tables=new int[10][4];   //Holds Meeting Tables Amounts 
        private static int []Bookcases=new int[12];             //Holds Bookcases Amounts 
        private static int []Office_Cabinets=new int[12];        //Holds Office Cabinets Amounts 
    ...
    /*-----------------------------------------------------------------------------------------*/
         ...
         */
        public void setOffice_Chairs(int[][]New_Office_Chairs){
    ...
    /*-----------------------------------------------------------------------------------------*/
         ...
         */
        public void setOffice_Desks(int[][]New_Office_Desks){
    ...
    /*-----------------------------------------------------------------------------------------*/
         ...
         */
        public void setMeeting_Tables(int[][]New_Meeting_Tables){
    ...
    /*-----------------------------------------------------------------------------------------*/
         ...
         * @param New_Bookcases
         */
        public void setBookcases(int[]New_Bookcases){
    ...
    /*-----------------------------------------------------------------------------------------*/
         ...
         */
        public void setOffice_Cabinets(int[]New_Office_Cabinets){
